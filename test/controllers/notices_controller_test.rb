...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body: @notice.body, notice_date: @notice.notice_date, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body: @notice.body, notice_date: @notice.notice_date, title: @notice.title } }
