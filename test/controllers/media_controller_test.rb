...
class MediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medium" do
    assert_difference('Medium.count') do
      post media_url, params: { medium: { body: @medium.body, media_date: @medium.media_date, title: @medium.title } }
    end
  ...
  test "should update medium" do
    patch medium_url(@medium), params: { medium: { body: @medium.body, media_date: @medium.media_date, title: @medium.title } }
